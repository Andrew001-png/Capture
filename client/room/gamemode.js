...
const UnCapturedColor = new Color(1, 1, 1);
const FakeCapturedColor = new Color(0, 1, 0); // к какому цвету стремится зона при ее захвате
...
defView.color = teams.BLUE_TEAM_COLOR;
